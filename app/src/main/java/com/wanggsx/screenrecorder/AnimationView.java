...
public class AnimationView extends View implements Handler.Callback {
    ...
    private void startPlay() {
        ...
        if ( mAnimDataList != null && mAnimDataList.size() > 0 ){
            ...
            mCurShowBmp = UtilsImage.getBitmap(getContext(),animData.filePath,mWidth,mHeight);
            invalidate();
            if (mListener != null ){
                ...
                public boolean handleMessage(Message msg) {
                    ...
                    switch (msg.what){
                        case PROCESS_DATA:{
                            ...
                            Bitmap bitmap = UtilsImage.getBitmap(mContext.get(),animData.filePath,mWidth,mHeight);
                            if (bitmap != null ){
